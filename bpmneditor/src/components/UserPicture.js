...
export default function UserPicture({name = "visitante", img = "https://capp.santafe.gob.ar/itop/env-production/itop-config-mgmt/images/silhouette.png", salir } ) {
  return (
    <div className="box p-3 d-flex justify-content-between align-items-center">
    <div>
      <svg onClick={salir} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-plugin" viewBox="0 0 16 16">
